...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"../src/components/ExternalLink/ExternalLink.css":[function(require,module,exports) {
var reloadCSS = require('_css_loader');

module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js"}],"../node_modules/tableau-api/index.js":[function(require,module,exports) {
...
},{}],"../src/components/ExternalLink/file-icon.png":[function(require,module,exports) {
module.exports = "/file-icon.cae6601b.png";
},{}],"../src/components/ExternalLink/pdf-icon.png":[function(require,module,exports) {
module.exports = "/pdf-icon.921795e6.png";
},{}],"../node_modules/react-select/src/utils.js":[function(require,module,exports) {
"use strict";
...
},{"raf":"../node_modules/raf/index.js"}],"../src/components/ExternalLink/ExternalLink.js":[function(require,module,exports) {
"use strict";
...
var _tableauApi = _interopRequireDefault(require("tableau-api"));

var _fileIcon = _interopRequireDefault(require("./file-icon.png"));

var _pdfIcon = _interopRequireDefault(require("./pdf-icon.png"));

var _utils = require("react-select/src/utils");
...
var i_figured_tableau_out = false; // change once tableau is somethig I understand
...
var ExternalLink = /*#__PURE__*/function (_React$Component) {
  ...
  function ExternalLink(props) {
    ...
    var self = _assertThisInitialized(_this); // eslint-disable-line


    self.tableauDownload = self.tableauDownload.bind(_assertThisInitialized(_this));
    self.myFunction = self.myFunction.bind(_assertThisInitialized(_this));
    return _this;
  }
  ...
  _createClass(ExternalLink, [{
    ...
    value: function componentDidMount() {
      ...
      if (linkType === 'tableau' && i_figured_tableau_out) {
        ...
        var link = message.link + '&:toolbar=no';
        var options = {
          hideTabs: true,
          width: '100%',
          height: '100%'
    ...
    key: "tableauDownload",
    value: function tableauDownload(type) {
    ...
    key: "getLinkTypeName",
    value: function getLinkTypeName(type) {
    ...
    value: function render() {
      ...
      var _this$props2 = this.props,
          ...
          mini = _this$props2.mini; // const returnedEntity = message.entity;

      var doclink = message.doclink + (linkType && i_figured_tableau_out === 'tableau' ? '&:toolbar=no' : ''); //console.log("doclink:",doclink);

      var link = message.link + (linkType && i_figured_tableau_out === 'tableau' ? '&:toolbar=no' : ''); //console.log("Link: ",link);

      if (message.doclink.length > 0 || message.link.length > 0) {
        //console.log("message.doclink.length > 1");
        if (message.entity == 'qtr') {
          //console.log("QUARTER");
          return [React.createElement("div", null, message.link.map(function (val, idx) {
            var link = message.link[idx] + (linkType && i_figured_tableau_out === 'tableau' ? '&:toolbar=no' : '');
            return (// <div className="ExternalLink mt-3 pt-2 pb-3" style={{ borderBottom: idx != (message.link.length - 1) ? "1px solid lightgray" : "3px solid #004F80" }}>
              React.createElement("div", {
                className: "ExternalLink mt-3 pt-2 pb-3",
                style: {
                  borderBottom: idx != message.link.length - 1 ? "1px solid lightgray" : "0px solid #004F80"
                }
              }, React.createElement("div", {
                className: "ExternalLink-top"
              }, mini && React.createElement("div", {
                className: "ExternalLink-header"
              }, React.createElement("div", {
                className: "ExternalLink-title"
              }, React.createElement("i", {
                className: "fas fa-link ExternalLink-title-icon"
              }), _this2.getLinkTypeName(linkType))), mini && React.createElement("i", {
                className: "ExternalLink-open-msg"
              }, " (click to open)"), !mini && React.createElement("div", {
                ...
                if (message.entity == 'document') {
                  return [React.createElement("a", {
                    href: link,
                    className: "pdfImg-btn",
                    target: "_blank"
                  }, React.createElement("img", {
                    src: _fileIcon.default,
                    alt: "PDF IMAGE",
                    className: "pdf-img"
              ...
              }())), !mini && linkType === 'tableau' && i_figured_tableau_out && React.createElement(React.Fragment, null, React.createElement("div", {
                className: "tableau-buttons"
              }, React.createElement("div", {
                className: "button-tableau-download",
                onClick: function onClick() {
                  return _this2.tableauDownload('pdf');
                }
              }, "PDF Download"), React.createElement("div", {
                className: "button-tableau-download",
                onClick: function onClick() {
                  return _this2.tableauDownload('excel');
                }
              }, "Excel Download"), React.createElement("div", {
                className: "button-tableau-download",
                onClick: function onClick() {
                  return _this2.tableauDownload('image');
                }
              }, "Image Download"))))
            );
          }))];
          ...
          return [React.createElement("div", null, message.link.map(function (val, idx) {
            ...
            return React.createElement("div", {
              className: "ExternalLink mt-3 pt-2 pb-3",
              style: {
                borderBottom: idx != message.link.length - 1 ? "1px solid lightgray" : "3px solid #004F80"
              }
            }, function () {
              if (idx == 0) {
                return React.createElement("div", {
          ...
          })), React.createElement("div", null, message.doclink.map(function (val, idx) {
            var link = message.doclink[idx] + (linkType && i_figured_tableau_out === 'tableau' ? '&:toolbar=no' : '');
            return React.createElement("div", {
              className: "ExternalLink mt-3 pt-2 pb-3",
              style: {
                borderBottom: idx != message.doclink.length - 1 ? "1px solid lightgray" : ""
              }
            }, function () {
              if (idx == 0) {
                return React.createElement("div", {
                  className: "LinkCategory"
                }, React.createElement("span", null, "Drive documents"));
              }
            }(), React.createElement("div", {
              className: "ExternalLink-top"
            }, mini && React.createElement("div", {
              ...
              var len = message.doctext[idx].length;
              var p = len - 3;
              var d = len - 2;
              var f = len - 1; //console.log(p);
              //console.log(message.doctext[idx][p].toLowerCase());

              var PDF = message.doctext[idx][p].toLowerCase() + message.doctext[idx][d].toLowerCase() + message.doctext[idx][f]; // if(message.doctext[idx][p] + message.doctext[idx][p] + message.doctext[idx][p] == 'pdf')
              // {console.log("PDF");
              // }
              ...
              if (message.docentity == 'document') {
                ...
                } else return [React.createElement("a", {
                  href: message.doclink[idx],
                  className: "pdfImg-btn",
                  target: "_blank"
                }, React.createElement("img", {
              ...
              className: "ExternalLink-link path"
            }, function () {
        ...
        return React.createElement("div", {
          ...
          className: "ExternalLink-top"
        }, mini && React.createElement("i", {
          className: "ExternalLink-open-msg"
        }, " (click to open)"), !mini && React.createElement("div", {
          className: "NoRecordFound"
        }, "I cannot answer this question now. I am going to sign up for additional training to answer this question.")), !mini && linkType === 'tableau' && i_figured_tableau_out && React.createElement(React.Fragment, null, React.createElement("div", {
          className: "tableau-buttons"
        }, React.createElement("div", {
          className: "button-tableau-download",
          onClick: function onClick() {
...
},{"react":"../node_modules/react/index.js","./ExternalLink.css":"../src/components/ExternalLink/ExternalLink.css","tableau-api":"../node_modules/tableau-api/index.js","./file-icon.png":"../src/components/ExternalLink/file-icon.png","./pdf-icon.png":"../src/components/ExternalLink/pdf-icon.png","react-select/src/utils":"../node_modules/react-select/src/utils.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
//# sourceMappingURL=/ExternalLink.c9142af7.js.map